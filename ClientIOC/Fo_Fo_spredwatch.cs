        ...
        private void DGV1_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if ((bool) checkCell.Value == true)
            {
             ...
             //   DataRow[] drr = Global.Instance.OrdetTable.Select("status='Traded'  and TokenNo='" + v.Token1 + "'  ");
              //  if (drr.Length > 0)
              //  {
               //     var _v = drr.AsEnumerable().Where(a => a.Field<string>("Buy_SellIndicator") == "BUY").Sum(a=>Convert.ToInt32(a.Field<string>("Volume")));
               //     _buycount = _v /_lotsize.lotsize / val;


               //     var _v1 = drr.AsEnumerable().Where(a => a.Field<string>("Buy_SellIndicator") == "SELL").Sum(a => Convert.ToInt32(a.Field<string>("Volume")));
               //     _sellcount = _v1 / _lotsize.lotsize / val;
