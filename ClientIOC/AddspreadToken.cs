                ...
                switch (Strategy_type_comboBox1.Text)
                {
                    ...
                    case "2_LEG":
                        if (txbStrategy.Text == "")
                        {
                            ...
                            label19.Text = "PLZ Enter Strategy Name";
                            return;
        ...
        private void AddToken_Load(object sender, EventArgs e)
        {
            ...
            else
            {
               ...
               // show1();
                ...
                ds.ReadXml(Application.StartupPath + Path.DirectorySeparatorChar + "SpreadProfiles" + Path.DirectorySeparatorChar + "Lostadtoken.xml");
        ...
        void select()
        {
            ...
            try
            {
                       ...
                       if (ds != null && ds.HasChanges())
                {
                    ...
                    for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                    {
                    if (txbStrategy.Text == ds.Tables[0].Rows[i][0].ToString())
                    {

                        XmlNode node = MyXmlDocument.SelectSingleNode("spreadtrackerDetails/spreadtracker[Strategy ='" + txbStrategy.Text + "']");
                        if (node != null)
            ...
            if (Strategy_type_comboBox1.Text == "2_LEG")
            {
                ...
                XmlElement ID = MyXmlDocument.CreateElement("Strategy");
                ID.InnerText = txbStrategy.Text;
           ...
           if (ds != null && ds.HasChanges())
                {
                    ...
                    for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                    {
                        ...
                        if (ds.Tables[0].Rows[i][0].ToString() == comboBox1.Text)
                        {
            ...
            outer:
                ...
                Strategy_type_comboBox1.Text = dst.Tables[0].Rows[j]["Strategy_type"].ToString();
            txbStrategy.Text = dst.Tables[0].Rows[j]["Strategy"].ToString();

                if (dst.Tables[0].Rows[j]["Strategy_type"].ToString() == "2_LEG")
                {
                    combox_OrderType.Text = dst.Tables[0].Rows[j]["Order_Type"].ToString();
                    Calc_typecomboBox1.Text = dst.Tables[0].Rows[j]["Calc_Type"].ToString();
                    EXcomboBox1.Text = dst.Tables[0].Rows[j]["Exchange1"].ToString();
                    ORcomboBox2.Text = dst.Tables[0].Rows[j]["Order_Type1"].ToString();
                    INSTcomboBox3.Text = dst.Tables[0].Rows[j]["Inst_Type1"].ToString();
                    SYMcomboBox4.Text = dst.Tables[0].Rows[j]["Symbol1"].ToString();
                    EXPcomboBox5.Text = dst.Tables[0].Rows[j]["Expiry1"].ToString();
                    L_O_S.Text = dst.Tables[0].Rows[j]["Lot_Size1"].ToString();
                    OPcomboBox6.Text = dst.Tables[0].Rows[j]["Option_Type1"].ToString();
                    // STRIKecomboBox7.Text = (node.SelectSingleNode("Strike_Price1").InnerText);
                    STRIKecomboBox7.Text = dst.Tables[0].Rows[j]["Strike_Price1"].ToString();
                    textBox_Ratio.Text = dst.Tables[0].Rows[j]["Ratio1"].ToString();
                    cmd_buy_sell1.Text = dst.Tables[0].Rows[j]["Buy_Sell"].ToString();

                    EXcomboBox2.Text = dst.Tables[0].Rows[j]["Exchange2"].ToString();
                    ORcomboBox3.Text = dst.Tables[0].Rows[j]["Order_Type2"].ToString();
                    INSTcomboBox4.Text = dst.Tables[0].Rows[j]["Inst_Type2"].ToString();
                    SYMcomboBox5.Text = dst.Tables[0].Rows[j]["Symbol2"].ToString();
                    EXPcomboBox6.Text = dst.Tables[0].Rows[j]["Expiry2"].ToString();
                    L_O_S2.Text = dst.Tables[0].Rows[j]["Lot_Size2"].ToString();
                    OPcomboBox7.Text = dst.Tables[0].Rows[j]["Option_Type2"].ToString();

                    //   STRIKecomboBox8.Text = (node.SelectSingleNode("Strike_Price2").InnerText);
                    STRIKecomboBox8.Text = dst.Tables[0].Rows[j]["Strike_Price2"].ToString();
                    textBox_Ratio2.Text = dst.Tables[0].Rows[j]["Ratio2"].ToString();
                    cmd_buy_sell2.Text = dst.Tables[0].Rows[j]["Buy_Sel2"].ToString();
                }
                else
                {
                    combox_OrderType.Text = dst.Tables[0].Rows[j]["Order_Type"].ToString();
                    ...
                    textBox_Ratio2.Text = dst.Tables[0].Rows[j]["Ratio2"].ToString();
                    cmd_buy_sell2.Text = dst.Tables[0].Rows[j]["Buy_Sel2"].ToString();
                    EXcomboBox3.Text = dst.Tables[0].Rows[j]["Exchange3"].ToString();
                    ORcomboBox4.Text = dst.Tables[0].Rows[j]["Order_Type3"].ToString();
                    INSTcomboBox5.Text = dst.Tables[0].Rows[j]["Inst_Type3"].ToString();
                    SYMcomboBox6.Text = dst.Tables[0].Rows[j]["Symbol3"].ToString();
                    EXPcomboBox7.Text = dst.Tables[0].Rows[j]["Expiry3"].ToString();
                    L_O_S3.Text = dst.Tables[0].Rows[j]["Lot_Size3"].ToString();
                    OPcomboBox8.Text = dst.Tables[0].Rows[j]["Option_Type3"].ToString();
                    //   STRIKecomboBox8.Text = (node.SelectSingleNode("Strike_Price2").InnerText);
                    STRIKecomboBox9.Text = dst.Tables[0].Rows[j]["Strike_Price3"].ToString();
                    textBox_Rati3.Text = dst.Tables[0].Rows[j]["Ratio3"].ToString();
                    cmd_buy_sell3.Text = dst.Tables[0].Rows[j]["Buy_Sel3"].ToString();
                }
...
cmd_buy_sell1.Enabled = false;

EXcomboBox2.Enabled = false;
ORcomboBox3.Enabled = false;
INSTcomboBox4.Enabled = false;
textBox_Ratio2.Enabled = false;
cmd_buy_sell2.Enabled = false;


EXcomboBox3.Enabled = false;
ORcomboBox4.Enabled = false;
INSTcomboBox5.Enabled = false;
textBox_Rati3.Enabled = false;
cmd_buy_sell3.Enabled = false;
